...
import { FiHeart, FiShoppingCart, FiPhone, FiMail } from "react-icons/fi";
...
const Contact = ({ onSignUpClick, onAboutClick, onHomeClick, onLoginClick, onMyAccountClick, onWishlistClick, wishlistCount, onCartClick, cartCount,onNavigate }: ContactProps) => {
    return (
        <>
